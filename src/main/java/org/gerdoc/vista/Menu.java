...
public class Menu
{
    ...
    public static void principal2( )
    {
        ...
        System.out.println("PROGRAMA DE FIGURAS");
        System.out.println("SELECCIONA UNA OPCION");
        System.out.println("1.- Consola Principal");
        System.out.println("2.- Consola Soto Chávez Efrén");
        System.out.println("3.- Consola Peña Canuto Luis Enrique");
        System.out.println("4.- Ventana Principal");
        System.out.println("5.- Ventana Soto Chávez Efrén");
        System.out.println("6.- Ventana Peña Canuto Luis Enrique");
